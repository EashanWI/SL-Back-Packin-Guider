...
class EmployeeDetailsActivity : AppCompatActivity() {
    ...
    private fun openUpdateDialog(
        ...
        val etEmpName = mDialogView.findViewById<EditText>(R.id.etVehiType)
        val etEmpAge = mDialogView.findViewById<EditText>(R.id.etVehiNo)
        val etEmpSalary = mDialogView.findViewById<EditText>(R.id.etEmail)
    ...
    private fun updateEmpData(
        ...
        val dbRef = FirebaseDatabase.getInstance().getReference("Employees").child(id)
        val empInfo = vehicleModel(id, name, age, salary)
